...
import {BAOTRANGTRUYEN_DOMAIN, PREF_KEYS, SEARCH_SORTERS} from "./constants";
...
export class Target implements ContentSource,
    ...
    info: RunnerInfo = {
        id: "baotangtruyen",
        website: BAOTRANGTRUYEN_DOMAIN,
        version: 0.1,
        name: "BaoTangTruyen",
        supportedLanguages: ["vi-vn"],
        thumbnail: "baotangtruyen.png",
