import {Target} from "../runners/manhuarock";
...
describe("Manhua Rock Tests", () => {
    ...
    test("Reader", async () => {
        const data = await source.getChapterData("84565", "https://manhuarockz.com/truyen/chuyen-sinh-thanh-lieu-dot-bien/chapter-221/44961");
