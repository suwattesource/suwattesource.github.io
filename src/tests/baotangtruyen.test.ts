import {Target} from "../runners/baotrangtruyen";
...
describe("BaoTangTruyen Tests", () => {
    ...
    test("Profile", async () => {
        const content = await source.getContent("https://baotangtruyen13.com/truyen-tranh/dua-con-bao-thu-280");
